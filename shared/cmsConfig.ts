    ...
    sections: [
      ...
      // ─── Daily Staff ───
      {
        ...
        fields: [
          ...
          { key: "staff1Name", label: "Staff 1 — Name", type: "text", storageKey: "metadata.staff1Name", placeholder: "e.g. Didi Ananda Kalika" },
          { key: "staff1Role", label: "Staff 1 — Role", type: "text", storageKey: "metadata.staff1Role", placeholder: "e.g. Director" },
          { key: "staff2Name", label: "Staff 2 — Name", type: "text", storageKey: "metadata.staff2Name", placeholder: "e.g. Bolormaa" },
          { key: "staff2Role", label: "Staff 2 — Role", type: "text", storageKey: "metadata.staff2Role", placeholder: "e.g. Centre Manager" },
          { key: "staff3Name", label: "Staff 3 — Name", type: "text", storageKey: "metadata.staff3Name", placeholder: "e.g. Suugi" },
          { key: "staff3Role", label: "Staff 3 — Role", type: "text", storageKey: "metadata.staff3Role", placeholder: "e.g. Administration" },
          { key: "staff4Name", label: "Staff 4 — Name", type: "text", storageKey: "metadata.staff4Name", placeholder: "e.g. Otara" },
          { key: "staff4Role", label: "Staff 4 — Role", type: "text", storageKey: "metadata.staff4Role", placeholder: "e.g. House Mother" },
          { key: "staff5Name", label: "Staff 5 — Name", type: "text", storageKey: "metadata.staff5Name", placeholder: "e.g. Delgermaa" },
          { key: "staff5Role", label: "Staff 5 — Role", type: "text", storageKey: "metadata.staff5Role", placeholder: "e.g. House Mother" },
          { key: "staff6Name", label: "Staff 6 — Name", type: "text", storageKey: "metadata.staff6Name", placeholder: "e.g. Narantuya" },
          { key: "staff6Role", label: "Staff 6 — Role", type: "text", storageKey: "metadata.staff6Role", placeholder: "e.g. House Mother" },
          { key: "staff7Name", label: "Staff 7 — Name", type: "text", storageKey: "metadata.staff7Name", placeholder: "e.g. Enkhtuvshin" },
          { key: "staff7Role", label: "Staff 7 — Role", type: "text", storageKey: "metadata.staff7Role", placeholder: "e.g. House Mother" },
          { key: "staff8Name", label: "Staff 8 — Name", type: "text", storageKey: "metadata.staff8Name", placeholder: "e.g. Udval" },
          { key: "staff8Role", label: "Staff 8 — Role", type: "text", storageKey: "metadata.staff8Role", placeholder: "e.g. House Mother" },
          { key: "staff9Name", label: "Staff 9 — Name", type: "text", storageKey: "metadata.staff9Name", placeholder: "e.g. Batbileg" },
          { key: "staff9Role", label: "Staff 9 — Role", type: "text", storageKey: "metadata.staff9Role", placeholder: "e.g. Cook" },
          { key: "staff10Name", label: "Staff 10 — Name", type: "text", storageKey: "metadata.staff10Name", placeholder: "e.g. Sainbuyan" },
          { key: "staff10Role", label: "Staff 10 — Role", type: "text", storageKey: "metadata.staff10Role", placeholder: "e.g. Doctor" },
          { key: "staff11Name", label: "Staff 11 — Name", type: "text", storageKey: "metadata.staff11Name", placeholder: "e.g. Ganbat" },
          { key: "staff11Role", label: "Staff 11 — Role", type: "text", storageKey: "metadata.staff11Role", placeholder: "e.g. Driver" },
          { key: "staff12Name", label: "Staff 12 — Name", type: "text", storageKey: "metadata.staff12Name", placeholder: "e.g. Bold" },
          { key: "staff12Role", label: "Staff 12 — Role", type: "text", storageKey: "metadata.staff12Role", placeholder: "e.g. Maintenance" },
          { key: "staff13Name", label: "Staff 13 — Name", type: "text", storageKey: "metadata.staff13Name", placeholder: "Leave empty if not needed" },
          { key: "staff13Role", label: "Staff 13 — Role", type: "text", storageKey: "metadata.staff13Role", placeholder: "Leave empty if not needed" },
          { key: "staff14Name", label: "Staff 14 — Name", type: "text", storageKey: "metadata.staff14Name", placeholder: "Leave empty if not needed" },
          { key: "staff14Role", label: "Staff 14 — Role", type: "text", storageKey: "metadata.staff14Role", placeholder: "Leave empty if not needed" },
          { key: "staff15Name", label: "Staff 15 — Name", type: "text", storageKey: "metadata.staff15Name", placeholder: "Leave empty if not needed" },
          { key: "staff15Role", label: "Staff 15 — Role", type: "text", storageKey: "metadata.staff15Role", placeholder: "Leave empty if not needed" },
        ],
      },
      // ─── Volunteer Section ───
      {
