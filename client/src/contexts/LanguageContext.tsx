...
const translations: Translations = {
  ...
  "about.aimsDesc": { en: "Our core values guide everything we do", mn: "Манай үндсэн үнэ цэнэ нь бидний хийх бүхнийг чиглүүлдэг" },
  ...
  "about.heroTitle": { en: "Our Story of Hope and Compassion", mn: "Манай найдвар, сочирхлын түүх" },
  "about.heroDesc": { en: "Building a loving home for vulnerable Mongolian children since 1995", mn: "1995 оноос эхлэн Монголын эмзэг хүүхдүүдийн хайр дүүрэн гэр бий болгож байна" },
  "about.whoWeAre": { en: "Who We Are", mn: "Бид хэн бэ" },
  "about.whoWeAreDesc": { en: "Lotus Children's Centre is a non-profit organization dedicated to providing shelter, care, education, and love to vulnerable children in Ulaanbaatar, Mongolia. Founded in 1995, we have been transforming lives for nearly three decades.", mn: "Лотус хүүхдийн төв нь Улаанбаатар, Монголын эмзэг хүүхдүүдэд хамгаалалт, асрамж, боловсрол, хайр өгөхөд зориулсан төрийн бус байгууллага юм. 1995 онд үүсгэгдсэн энэ байгууллага гараг гараг жилийн турш амьдралыг өөрчлөж байна." },
  "about.primaryCare": { en: "Primary Care", mn: "Анхан шатны асрамж" },
  "about.primaryCareDesc": { en: "Provide food, healthcare, clothing and suitable accommodation", mn: "Хоол, эрүүл мэнд, хувцас, тохиромжтой байр зэргийг үзүүлэх" },
  "about.development": { en: "Development", mn: "Хөгжил" },
  "about.developmentDesc": { en: "Quality education, counselling, and life skills for breaking poverty cycles", mn: "Ядуурлын мөчлөгөөс гарахын тулд чанартай боловсрол, зөвлөгөө, амьдралын ур чадвар" },
  "about.familySupport": { en: "Family Support", mn: "Гэр бүлийн дэмжлэг" },
  "about.familySupportDesc": { en: "Love, attention, and family group support for every child", mn: "Хүүхэд бүрт хайр, анхаарал, гэр бүлийн бүлгийн дэмжлэг" },
  "about.applicationForm": { en: "Application Form", mn: "Өргөдлийн маягт" },
  "about.faq": { en: "FAQ", mn: "Байнга асуудаг асуулт" },
  "about.volunteerApplicationForm": { en: "Volunteer Application Form", mn: "Сайн дурын ажилтны өргөдлийн маягт" },
  "about.frequentlyAskedQuestions": { en: "Frequently Asked Questions", mn: "Байнга асуудаг асуултууд" },
  "about.submit": { en: "Submit", mn: "Илгээх" },
  "about.cancel": { en: "Cancel", mn: "Цуцлах" },
