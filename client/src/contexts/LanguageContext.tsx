...
const translations: Translations = {
  ...
  // Get Involved Page
  "getInvolved.heroTitle": { en: "Get Involved!", mn: "Оролцоорой!" },
  "getInvolved.heroDesc": { en: "Have you gotten just as excited about Lotus as we are? Good news! There are multiple ways that you can help out.", mn: "Та бидэнтэй адил Лотусын талаар сэтгэл хөдөлж байна уу? Сайн мэдээ! Та тусалж чадах олон арга бий." },
  "getInvolved.volunteerTitle": { en: "Volunteer Opportunities", mn: "Сайн дурын ажлын боломж" },
  "getInvolved.volunteerDesc": { en: "On-site or from further away, volunteers are always welcome at Lotus Children's Centre.", mn: "Газар дээр нь эсвэл алсаас, сайн дурын ажилтнуудыг Лотус хүүхдийн төвд үргэлж хүлээн авдаг." },
  "getInvolved.volunteerCta": { en: "Volunteer for Lotus", mn: "Лотуст сайн дурын ажил хийх" },
  "getInvolved.volunteerDetail1": { en: "Teach English, art, music, or sports to the children", mn: "Хүүхдүүдэд англи хэл, урлаг, хөгжим, спорт заах" },
  "getInvolved.volunteerDetail2": { en: "Help with daily activities and community outreach", mn: "Өдөр тутмын үйл ажиллагаа, нийгмийн хүрээнд тусалах" },
  "getInvolved.volunteerDetail3": { en: "Remote volunteering opportunities available", mn: "Алсаас сайн дурын ажил хийх боломж бий" },
  "getInvolved.fundraiseTitle": { en: "Fundraising Opportunities", mn: "Хөрөнгө босгох боломж" },
  "getInvolved.fundraiseDesc": { en: "Take a look at the different events organised for Lotus Children's Centre.", mn: "Лотус хүүхдийн төвд зориулан зохион байгуулсан янз бүрийн арга хэмжээг үзнэ үү." },
  "getInvolved.fundraiseCta": { en: "Sponsor Lotus", mn: "Лотусыг ивээн тэтгэх" },
  "getInvolved.fundraiseDetail1": { en: "Organize charity events in your community", mn: "Өөрийн нийгэмлэгт буяны арга хэмжээ зохион байгуулах" },
  "getInvolved.fundraiseDetail2": { en: "Corporate sponsorship and partnership programs", mn: "Байгууллагын ивээн тэтгэлэг, түншлэлийн хөтөлбөрүүд" },
  "getInvolved.fundraiseDetail3": { en: "Run a personal fundraising campaign online", mn: "Онлайнаар хувийн хөрөнгө босгох кампанит ажил явуулах" },
  "getInvolved.donateTitle": { en: "Make a Donation", mn: "Хандив өгөх" },
  "getInvolved.donateDesc": { en: "Through money or objects, donations help with the running of Lotus Children's Centre.", mn: "Мөнгө эсвэл эд зүйлсээр дамжуулан хандив нь Лотус хүүхдийн төвийн үйл ажиллагаанд тусалдаг." },
  "getInvolved.donateCta": { en: "Donate Now", mn: "Одоо хандив өгөх" },
  "getInvolved.donateDetail1": { en: "One-time or recurring monthly donations", mn: "Нэг удаагийн эсвэл сар бүрийн давтагдах хандив" },
  "getInvolved.donateDetail2": { en: "Donate supplies, clothing, or educational materials", mn: "Хэрэгсэл, хувцас, боловсролын материал хандивлах" },
  "getInvolved.donateDetail3": { en: "All donations go directly to supporting the children", mn: "Бүх хандив хүүхдүүдийг дэмжихэд шууд зарцуулагдана" },
  "getInvolved.childrenHelped": { en: "Children helped yearly", mn: "Жил бүр тусалсан хүүхдүүд" },
  "getInvolved.whyTitle": { en: "Why Get Involved", mn: "Яагаад оролцох вэ" },
  "getInvolved.whyHeading": { en: "Your Support Changes Lives", mn: "Таны дэмжлэг амьдралыг өөрчилдөг" },
  "getInvolved.whyDesc1": { en: "The Lotus Children's Centre is home to around 75 vulnerable and abused Mongolian children. Located in Gachuurt in the suburbs of Ulaanbaatar, it provides not only shelter but also education, healthcare, and a loving family environment.", mn: "Лотус хүүхдийн төв нь 75 орчим эмзэг, хүчирхийлэлд өртсөн Монгол хүүхдүүдийн гэр юм. Улаанбаатарын захын Гачууртад байрладаг энэ төв нь зөвхөн хамгаалалт төдийгүй боловсрол, эрүүл мэнд, хайр дүүрэн гэр бүлийн орчинг бий болгодог." },
  "getInvolved.whyDesc2": { en: "Whether you volunteer your time, organize a fundraiser, or make a donation, every contribution makes a real difference in the lives of these children. Join us in building a brighter future.", mn: "Та цагаа зориулж сайн дурын ажил хийх, хөрөнгө босгох арга хэмжээ зохион байгуулах, эсвэл хандив өгөх аль ч байсан, таны оруулсан хувь нэмэр эдгээр хүүхдүүдийн амьдралд жинхэнэ өөрчлөлт авчирдаг." },
  "getInvolved.statChildren": { en: "Children Each Year", mn: "Хүүхэд жил бүр" },
  "getInvolved.statYears": { en: "Years of Service", mn: "Жилийн үйлчилгээ" },
  "getInvolved.statLives": { en: "Lives Changed", mn: "Амьдрал өөрчлөгдсөн" },
  "getInvolved.ctaTitle": { en: "Ready to Make a Difference?", mn: "Өөрчлөлт хийхэд бэлэн үү?" },
  "getInvolved.ctaDesc": { en: "Contact us to learn more about how you can support Lotus Children's Centre and help vulnerable children in Mongolia.", mn: "Лотус хүүхдийн төвийг хэрхэн дэмжих, Монголын эмзэг хүүхдүүдэд хэрхэн туслах талаар дэлгэрэнгүй мэдээлэл авахын тулд бидэнтэй холбогдоорой." },
  "getInvolved.emailUs": { en: "Email Us", mn: "Имэйл илгээх" },
  "getInvolved.callUs": { en: "Call Us", mn: "Залгах" },
